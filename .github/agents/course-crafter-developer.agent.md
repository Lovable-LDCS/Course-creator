...
description: Expert agent for Course Crafter project development following One-Time Build, True North architecture, and strict wiring principles. Handles full-stack development, QA automation, and architecture-first workflows.
tools:
  - read
  - edit
  - search
